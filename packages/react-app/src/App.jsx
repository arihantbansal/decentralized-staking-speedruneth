...
function App(props) {
  ...
  const [amountToStake, setAmountToStake] = useState(0.1);
          ...
          <Route exact path="/">
            ...
            <div style={{ padding: 8 }}>
              ...
              <Button
                ...
                onClick={() => {
                  tx(writeContracts.Staker.stake({ value: ethers.utils.parseEther(String(amountToStake)) }));
                }}
              >
                🥩 Stake {amountToStake || "0"} ether!
              </Button>
            </div>
